...
When visitor searches for Pittsburgh
Then the website should show the businesses in Pittsburgh
...
Then the website should be on the page of Food

Scenario:Search for Dessert
Given visitor is on food page
When visitor selects Desserts
Then the website should be on the page of Desserts
